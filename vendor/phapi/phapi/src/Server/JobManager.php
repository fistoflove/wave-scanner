...
{
    /**
     * @var array<string, array{interval: int, handler: callable(Logger): void}>
     */
    private array $jobs = [];
    /**
     ...
     * @param callable(Logger): void $handler Job handler receives: ($logger)
     * @return void
     */
     ...
     *
     * @param string $name Job name
     * @param array{interval: int, handler: callable(Logger): void} $job Job configuration
     * @return void
     */
     ...
     *
     * @return array<int, string> Job names
     */
